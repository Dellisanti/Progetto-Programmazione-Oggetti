...
public class Variances {
	...
	public City ShowMaxVariances(RequestBodyClass body) throws ParseException {
	...
	public City ShowMinVariances(RequestBodyClass body) throws ParseException {
		...
		city.setName("Varianza minima dal "+orari.get(0).getSunrise().substring(0,10)+
				" al "+orari.get(orari.size()-1).getSunrise().substring(0,10));
		long minsSunrise = (minSunrise%3600)/60;
